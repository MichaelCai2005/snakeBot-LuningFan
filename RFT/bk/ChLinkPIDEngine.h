...
#ifndef ChLinkPIDEngineCONTROL_H
#define ChLinkPIDEngineCONTROL_H
...
#define LNK_PID_ENGINE		1000
    ...
    class ChLinkPIDEngine : public ChLinkLock {

        CH_RTTI(ChLinkPIDEngine, ChLinkLock);
    ...
    protected:
        ...
        bool impose_torque_limit;
        double torque_limit_max;
        double torque_limit_min;
        double rot_gain;
        double der_gain;
        double int_gain;
        double cum_erno;
    ...
    public:
        ...
        ChLinkPIDEngine();
        virtual ~ChLinkPIDEngine();
        virtual void Copy(ChLinkPIDEngine* source);
        ...
        void Get_mot_torque_limits(double *tormax, double *tormin);
        void Set_mot_torque_limits(double tormax = 0., double tormin = 0.);
        void Set_mot_gain(double g1 = 0, double g2 = 0, double g3 = 0);
        void Get_mot_gain(double* g1, double* g2, double* g3);
    };
